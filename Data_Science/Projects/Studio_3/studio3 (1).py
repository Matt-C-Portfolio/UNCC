...
def scatterVsTarget(data, target_variable, nrows=3, ncols=3, title='Scatterplots of Predictors vs Target',
                           face_color='#323335', title_color='#EBD8D4', line_color='#fef176', scatter_color='#ddd0ca'):
    """
...
def plotResiduals(models, X_test1, X_test2, y_test, model_titles=None, 
                   ...
                   face_color='#323335', title_color='#ddd0ca', 
                   line_color='#fef176', scatter_color='#ddd0ca', text_color='#EBD8D4'):
    """
    ...
    for i, (model, model_title) in enumerate(zip(models, model_titles)):
        ...
        axs[i][0].set_title(f'Q-Q Plot - {model_title}', color=text_color)
        axs[i][0].set_xlabel('Expected Quantiles', color=text_color)
        axs[i][0].set_ylabel('Observed Quantiles', color=text_color)
        ...
        axs[i][1].set_title(f'Distribution of Residuals - {model_title}', color=text_color)
        axs[i][1].set_xlabel('Residual', color=text_color)
        axs[i][1].set_ylabel('Frequency', color=text_color)
        ...
        axs[i][2].set_title(f'KDE Plot - {model_title}', color=text_color)
        axs[i][2].set_xlabel('Residual', color=text_color)
        axs[i][2].set_ylabel('Density', color=text_color)
        ...
        for j in range(3):
            ...
            axs[i][j].tick_params(axis='y', colors=text_color)
            axs[i][j].tick_params(axis='x', colors=text_color)
